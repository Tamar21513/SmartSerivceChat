...
# Split text into overlapping chunks of a fixed number of words
...
# Check whether a line qualifies as a title based on its word count
...
# Split text into sections by title lines, chunking any section that exceeds the max word count
