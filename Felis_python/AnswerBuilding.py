...
# Ensure the model output has a clean "answer:" / "ending:" format, stripping known bad filler sentences
...
# Strip known leaked prompt-instruction phrases from the raw model output, then fix its format
...
# Generate the final customer support answer for a question using the FLAN-T5 model
