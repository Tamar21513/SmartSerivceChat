...
class QAMatchingTransformer(nn.Module):
    # Build the embedding layer, stack of encoder blocks, and final classification head
    ...
    # Run the input through the embeddings and encoder blocks, then classify the pooled output as a match score
