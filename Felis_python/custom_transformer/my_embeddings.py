...
class MyQAMatchingTransformerEmbeddings(nn.Module):
    # Initialize the token embedding, positional embedding, layer norm and dropout layers
    ...
    # Combine weighted token embeddings with positional embeddings, then normalize and apply dropout
